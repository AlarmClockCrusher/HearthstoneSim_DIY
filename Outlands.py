...
class ScavengersIngenuity(Spell):
	...
	def whenEffective(self, target=None, comment="", choice=0, posinHand=-2):
		PRINT(self, "Scavenger's Ingenuity is cast, lets player draw a Beast and gives it +2/+2")
		beastsinDeck = []
...
class ImprisonedScrapImp(Minion_Dormantfor2turns):
	...
	def awakenEffect(self):
		PRINT(self, "Imprisoned Scrap Imp awakens and gives all minion in player's hand +2/+1")
